...
public class AppLogin extends javax.swing.JFrame {
    ...
    public AppLogin() {
        ...
        // Disables items except for cancel button before connection
        initItems();        
        
        // Calls timer to time connection
        timer();
    }
    ...
    private void initComponents() {
        ...
        btn_LogIn.setBounds(60, 160, 87, 25);
        ...
        btn_Cancel.setBounds(170, 160, 87, 25);
    ...
    private void btn_LogInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LogInActionPerformed
        ...
        try {
            ...
            String query = "SELECT TOP (1) [EmployeeNickName], [EmployeePassword] "
                + "FROM [BookShop].[dbo].[Employee] WHERE [EmployeeNickName] = ? AND [EmployeePassword] = ?";
            preparedStatement = connection.prepareStatement(query);
            preparedStatement.setString(1, txtFld_Username.getText());
            preparedStatement.setString(2, String.valueOf(pwdFld_Password.getPassword()));
            resultSet = preparedStatement.executeQuery();
            resultSet.next();
            
            // Compares user inputs with row set data 
            if (txtFld_Username.getText().equals(resultSet.getString(1)) &&
                String.valueOf(pwdFld_Password.getPassword()).equals(resultSet.getString(2))) {
